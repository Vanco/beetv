...
data class IndexResultData(
    ...
    companion object {
        fun fromIndexResultData(data: vanstudio.tv.biliapi.http.entity.index.IndexResultData) =
            IndexResultData(
...
data class IndexResultItem(
    ...
    companion object {
        fun fromIndexResultItem(item: vanstudio.tv.biliapi.http.entity.index.IndexResultData.IndexResultItem): IndexResultItem {
