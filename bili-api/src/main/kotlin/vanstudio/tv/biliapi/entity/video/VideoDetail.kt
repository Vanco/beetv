...
import vanstudio.tv.biliapi.entity.user.Author
import vanstudio.tv.biliapi.entity.video.season.UgcSeason
import vanstudio.tv.biliapi.http.entity.video.VideoStat
...
data class VideoDetail(
    ...
    companion object {
        ...
        fun fromVideoDetail(videoDetail: vanstudio.tv.biliapi.http.entity.video.VideoDetail) =
            VideoDetail(
    ...
    data class PlayerIcon(
        ...
        companion object {
            fun fromPlayerIcon(playerIcon: vanstudio.tv.biliapi.http.entity.video.VideoMoreInfo.PlayerIcon?) =
                playerIcon?.let {
                    PlayerIcon(
