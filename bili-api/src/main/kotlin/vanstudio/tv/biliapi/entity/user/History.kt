...
data class HistoryData(
    ...
    companion object {
        fun fromHistoryResponse(data: vanstudio.tv.biliapi.http.entity.history.HistoryData) =
            HistoryData(
...
data class HistoryItem(
    ...
    companion object {
        fun fromHistoryItem(item: vanstudio.tv.biliapi.http.entity.history.HistoryItem) =
            HistoryItem(
