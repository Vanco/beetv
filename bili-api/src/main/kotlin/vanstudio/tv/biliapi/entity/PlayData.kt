...
data class PlayData(
    ...
    companion object {
        ...
        fun fromPlayUrlData(playUrlData: vanstudio.tv.biliapi.http.entity.video.PlayUrlData): PlayData {
        ...
        fun fromPlayUrlData(playUrlData: vanstudio.tv.biliapi.http.entity.proxy.ProxyWebPlayUrlData): PlayData {
            val videos = playUrlData.dash?.video ?: emptyList()
            val audios = playUrlData.dash?.audio
            val dolbyItem = playUrlData.dash?.dolby?.audio?.firstOrNull()
            val flacItem = playUrlData.dash?.flac?.audio
        ...
        fun fromPlayUrlData(playUrlData: vanstudio.tv.biliapi.http.entity.proxy.ProxyAppPlayUrlData): PlayData {
            val videos = playUrlData.dash?.video ?: emptyList()
            val audios = playUrlData.dash?.audio
            val dolbyItem = playUrlData.dash?.dolby?.audio?.firstOrNull()
            val flacItem = playUrlData.dash?.flac?.audio
