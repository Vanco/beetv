...
data class Timeline(
    ...
    companion object {
        fun fromTimeline(timeline: vanstudio.tv.biliapi.http.entity.video.Timeline) = Timeline(
...
data class TimelineEp(
    ...
    companion object {
        fun fromTimelineEpisode(episode: vanstudio.tv.biliapi.http.entity.video.Timeline.Episode) =
            TimelineEp(
                cover = episode.cover,
                title = episode.title,
