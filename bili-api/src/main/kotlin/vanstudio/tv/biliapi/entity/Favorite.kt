...
import vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteItemId
...
data class FavoriteFolderMetadata(
    ...
    companion object {
        fun fromHttpFavoriteFolderInfo(httpFavoriteFolderInfo: vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteFolderInfo): FavoriteFolderMetadata {
        ...
        fun fromHttpUserFavoriteFolder(httpUserFavoriteFoldersData: vanstudio.tv.biliapi.http.entity.user.favorite.UserFavoriteFoldersData.UserFavoriteFolder): FavoriteFolderMetadata {
            return FavoriteFolderMetadata(
...
data class FavoriteFolderData(
    ...
    companion object {
        fun fromHttpFavoriteFolderInfoListData(httpFavoriteFolderInfoListData: vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteFolderInfoListData): FavoriteFolderData {
...
data class FavoriteItem(
    ...
    companion object {
        fun fromHttpFavoriteItem(httpFavoriteItem: vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteItem): FavoriteItem {
            return FavoriteItem(
...
data class Upper(
    ...
    companion object {
        fun fromHttpUpper(httpUpper: vanstudio.tv.biliapi.http.entity.user.favorite.Upper): Upper {
            return Upper(
                mid = httpUpper.mid,
                name = httpUpper.name,
                face = httpUpper.face
