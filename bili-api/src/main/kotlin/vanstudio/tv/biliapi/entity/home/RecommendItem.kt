...
import vanstudio.tv.biliapi.util.convertStringTimeToSeconds
...
data class RecommendItem(
    ...
    companion object {
        fun fromRcmdItem(rcmdItem: vanstudio.tv.biliapi.http.entity.home.RcmdIndexData.RcmdItem) =
            RecommendItem(
        ...
        fun fromRcmdItem(rcmdItem: vanstudio.tv.biliapi.http.entity.home.RcmdTopData.RcmdItem) =
            RecommendItem(
                aid = rcmdItem.id,
                bvid = rcmdItem.bvid,
                title = rcmdItem.title,
