...
data class DynamicVideoData(
    ...
    companion object {
        ...
        fun fromDynamicData(data: vanstudio.tv.biliapi.http.entity.dynamic.DynamicData) =
            DynamicVideoData(
...
data class DynamicVideo(
    ...
    companion object {
        fun fromDynamicVideoItem(item: vanstudio.tv.biliapi.http.entity.dynamic.DynamicItem): DynamicVideo {
