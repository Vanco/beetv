...
import vanstudio.tv.biliapi.http.entity.BiliResponseWithoutData
import vanstudio.tv.biliapi.http.entity.anime.AnimeFeedData
import vanstudio.tv.biliapi.http.entity.anime.AnimeHomepageData
import vanstudio.tv.biliapi.http.entity.anime.AnimeHomepageDataType
import vanstudio.tv.biliapi.http.entity.anime.AnimeHomepageDataV1
import vanstudio.tv.biliapi.http.entity.anime.AnimeHomepageDataV2
import vanstudio.tv.biliapi.http.entity.danmaku.DanmakuData
import vanstudio.tv.biliapi.http.entity.danmaku.DanmakuResponse
import vanstudio.tv.biliapi.http.entity.dynamic.DynamicData
import vanstudio.tv.biliapi.http.entity.history.HistoryData
import vanstudio.tv.biliapi.http.entity.home.RcmdIndexData
import vanstudio.tv.biliapi.http.entity.home.RcmdTopData
import vanstudio.tv.biliapi.http.entity.index.IndexResultData
import vanstudio.tv.biliapi.http.entity.search.AppSearchSquareData
import vanstudio.tv.biliapi.http.entity.search.KeywordSuggest
import vanstudio.tv.biliapi.http.entity.search.SearchResultData
import vanstudio.tv.biliapi.http.entity.search.SearchTendingData
import vanstudio.tv.biliapi.http.entity.search.WebSearchSquareData
import vanstudio.tv.biliapi.http.entity.season.AppSeasonData
import vanstudio.tv.biliapi.http.entity.season.FollowingSeasonAppData
import vanstudio.tv.biliapi.http.entity.season.FollowingSeasonWebData
import vanstudio.tv.biliapi.http.entity.season.SeasonFollowData
import vanstudio.tv.biliapi.http.entity.season.WebSeasonData
import vanstudio.tv.biliapi.http.entity.user.AppSpaceVideoData
...
import vanstudio.tv.biliapi.http.entity.user.RelationData
import vanstudio.tv.biliapi.http.entity.user.RelationStat
import vanstudio.tv.biliapi.http.entity.user.UserCardData
import vanstudio.tv.biliapi.http.entity.user.UserFollowData
import vanstudio.tv.biliapi.http.entity.user.UserInfoData
import vanstudio.tv.biliapi.http.entity.user.WebSpaceVideoData
import vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteFolderInfo
import vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteFolderInfoListData
import vanstudio.tv.biliapi.http.entity.user.favorite.FavoriteItemIdListResponse
import vanstudio.tv.biliapi.http.entity.user.favorite.UserFavoriteFoldersData
import vanstudio.tv.biliapi.http.entity.user.garb.Equip
import vanstudio.tv.biliapi.http.entity.user.garb.EquipPart
import vanstudio.tv.biliapi.http.entity.video.AddCoin
import vanstudio.tv.biliapi.http.entity.video.CheckSentCoin
import vanstudio.tv.biliapi.http.entity.video.CheckVideoFavoured
import vanstudio.tv.biliapi.http.entity.video.PlayUrlData
import vanstudio.tv.biliapi.http.entity.video.PopularVideoData
import vanstudio.tv.biliapi.http.entity.video.RelatedVideosResponse
import vanstudio.tv.biliapi.http.entity.video.SetVideoFavorite
import vanstudio.tv.biliapi.http.entity.video.Tag
import vanstudio.tv.biliapi.http.entity.video.TagDetail
import vanstudio.tv.biliapi.http.entity.video.TagTopVideosResponse
import vanstudio.tv.biliapi.http.entity.video.Timeline
import vanstudio.tv.biliapi.http.entity.video.TimelineAppData
import vanstudio.tv.biliapi.http.entity.video.VideoDetail
import vanstudio.tv.biliapi.http.entity.video.VideoInfo
import vanstudio.tv.biliapi.http.entity.video.VideoMoreInfo
import vanstudio.tv.biliapi.http.entity.video.VideoShot
import vanstudio.tv.biliapi.http.entity.web.NavResponseData
import vanstudio.tv.biliapi.http.util.BiliAppConf
import vanstudio.tv.biliapi.http.util.encApiSign
...
object BiliHttpApi {
    ...
    suspend fun getKeywordSuggest(
        ...
        // io.ktor.client.call.NoTransformationFoundException: Expected response body of the type 'class vanstudio.tv.biliapi.http.entity.search.KeywordSuggest (Kotlin reflection is not available)' but was 'class io.ktor.utils.io.ByteBufferChannel (Kotlin reflection is not available)'
